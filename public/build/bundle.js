    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$3, 15, 4, 342);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "name", "name");
    			attr_dev(input1, "placeholder", "Name");
    			add_location(input1, file$3, 17, 8, 446);
    			attr_dev(input2, "type", "email");
    			attr_dev(input2, "placeholder", "Email");
    			add_location(input2, file$3, 18, 8, 535);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h10, file, 13, 1, 347);
    			attr_dev(h11, "id", "Projects");
    			attr_dev(h11, "class", "svelte-d2aly4");
    			add_location(h11, file, 15, 1, 401);
